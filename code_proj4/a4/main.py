...
def train_images(
    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            # imageio.mimsave('images/part_5.2_20view.gif', [np.uint8(im * 255) for im in test_images])
            ...
            try:
                ...
                # imageio.mimsave('images/part_5.2_geometry_20view.gif', [np.uint8(im * 255) for im in test_images])
            except Exception as e:
                print("Empty mesh")
                pass
