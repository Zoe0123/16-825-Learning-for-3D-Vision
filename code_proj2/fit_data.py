...
def train_model(args):
    ...
    if args.type == "vox":
        ...
        # obj_path = os.path.join(dataset_location.SHAPENET_PATH, feed['synset_id'], feed['model_id'], 'model.obj')
        render_vox(voxels_src, output_path='images/q_1-1-src.gif')
        render_vox(voxels_tgt, output_path='images/q_1-1-tgt.gif')
        ...
        render_pc(pointclouds_src, output_path='images/q_1-2-src.gif')
        render_pc(pointclouds_tgt, output_path='images/q_1-2-tgt.gif')
        ...
        render_mesh(mesh_src, output_path='images/q_1-3-src.gif')
        render_mesh(mesh_tgt, output_path='images/q_1-3-tgt.gif')
