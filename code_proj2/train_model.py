...
def get_args_parser():
    ...
    parser.add_argument('--max_iter', default=1000, type=str) #10000
    parser.add_argument('--log_freq', default=2000, type=str) #1000
    parser.add_argument('--batch_size', default=4, type=str) #2
    ...
    parser.add_argument('--save_freq', default=1000, type=int) #10000
...
def train_model(args):
    ...
    if args.load_checkpoint:
        checkpoint = torch.load(f'checkpoint_{args.type}_10000.pth')
    ...
    for step in range(start_iter, args.max_iter):
        ...
        if (step % args.save_freq) == args.save_freq-1:
            torch.save({
                ...
                }, f'/mnt/data/checkpoint_{args.type}_10000.pth') # changed this!! originally f'checkpoint_{args.type}.pth'
